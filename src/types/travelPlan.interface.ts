import { IUserGender } from "./user.interface";
...
export interface IParticipantDetails {
  userId?: string; // Reference to User if participant is a registered user
  bookingId?: string; // Reference to Booking that added this participant
  name: string;
