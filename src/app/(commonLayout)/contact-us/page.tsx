          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="shadow-xl border-0">
              <CardContent className="p-8 text-center bg-card rounded-xl h-full flex flex-col items-center">
                ...
                <p className="text-primary font-semibold hover:underline mt-auto">
                  +880 1712 456 789
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-primary text-center text-white">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-muted mb-8">
            Haven't found what you're looking for? Browse our Frequently Asked
            Questions to find the answer.
          </p>
          <Button variant="outline" className="text-primary" size="lg" asChild>
