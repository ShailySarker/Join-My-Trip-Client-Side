...
export default function TravelPlanFilters({
  ...
  useEffect(() => {
    ...
    setIsApproved(searchParams.get("isApproved") || "");
  ...
  const handleApplyFilters = () => {
    ...
    if (showStatusFilter && isApproved && isApproved !== "_all")
  ...
  const isApprovedOptions = [
    { value: "_all", label: "All Approval Status" },
    ...Object.values(ITrevelIsApproved).map((s) => ({
      value: s,
      label: s,
    })),
  ];
  const statusOptions = [
    ...
    ...Object.values(ITrevelStatus).map((s) => ({
      value: s,
      label: s,
    })),
  ];
