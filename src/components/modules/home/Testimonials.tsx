      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Hear from travelers who found their perfect companions and created unforgettable memories.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review, index) => (
            ...
            >
                <Card
                  className="border-none shadow-lg hover:shadow-2xl transition-all duration-300 h-full bg-card/80 backdrop-blur-sm relative overflow-hidden group"
                >
                  ...
                  <CardContent className="p-8 space-y-6 flex flex-col h-full">
                    ...
                    <p className="text-muted-foreground italic text-lg leading-relaxed line-clamp-4 flex-grow relative z-10">
                      "{review.comment}"
                    </p>
                    <div className="flex items-center gap-4 pt-6 border-t border-border/50">
                      <Avatar className="w-14 h-14 border-2 border-primary/20 ring-2 ring-background">
                        <AvatarImage src={review.reviewerId?.profilePhoto} className="object-cover" />
