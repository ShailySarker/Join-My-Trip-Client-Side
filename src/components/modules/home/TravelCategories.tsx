...
const travelCategories: TravelCategory[] = [
  ...
  },
  {
    ...
    icon: Binoculars,
    color: "text-lime-600 bg-lime-50 dark:bg-lime-900/20 group-hover:bg-lime-600 group-hover:text-white",
  },
  {
    label: "Road Trips",
  ...
  },
  {
    ...
    icon: Crown,
    color: "text-stone-600 bg-stone-50 dark:bg-stone-900/20 group-hover:bg-stone-600 group-hover:text-white",
  },
  {
    label: "Camping",
    value: ITrevelInterest.CAMPING,
    icon: Tent,
    color: "text-teal-600 bg-teal-50 dark:bg-teal-900/20 group-hover:bg-teal-600 group-hover:text-white",
  },
  {
    label: "Nightlife",
  ...
  },
  {
    ...
    icon: Building2,
    color: "text-sky-600 bg-sky-50 dark:bg-sky-900/20 group-hover:bg-sky-600 group-hover:text-white",
  },
  {
    label: "Village Life",
    value: ITrevelInterest.VILLAGE_LIFE,
    icon: Leaf,
    color: "text-lime-700 bg-lime-50 dark:bg-lime-900/20 group-hover:bg-lime-700 group-hover:text-white",
  },
  {
    label: "Photography",
  ...
  },
  {
    ...
    color: "text-rose-600 bg-rose-50 dark:bg-rose-900/20 group-hover:bg-rose-600 group-hover:text-white",
  },
  {
    label: "Shopping",
    value: ITrevelInterest.SHOPPING,
    icon: ShoppingBag,
    color: "text-fuchsia-600 bg-fuchsia-50 dark:bg-fuchsia-900/20 group-hover:bg-fuchsia-600 group-hover:text-white",
  },
  {
    label: "Relaxation",
    value: ITrevelInterest.RELAXATION,
    icon: Sparkles,
    color: "text-cyan-600 bg-cyan-50 dark:bg-cyan-900/20 group-hover:bg-cyan-600 group-hover:text-white",
  },
  {
    label: "International",
    value: ITrevelInterest.INTERNATIONAL,
    icon: Globe,
    color: "text-violet-600 bg-violet-50 dark:bg-violet-900/20 group-hover:bg-violet-600 group-hover:text-white",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Find trips that match your passion, from mountain hiking to cultural exploration.
          </p>
        </motion.div>
            ...
            return (
              <motion.div key={index} variants={itemVariants}>
                ...
                >
                  ...
                  <p className="font-semibold text-sm group-hover:text-primary transition-colors text-center">{cat.label}</p>
                </Link>
              </motion.div>
            );
          })}
